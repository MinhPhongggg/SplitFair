...
const styles = StyleSheet.create({
  ...
  dateBox: {
    backgroundColor: '#F5F7FA', padding: 8, borderRadius: 10, alignItems: 'center', marginRight: 12, width: 50,
  },
  dateMonth: { fontSize: 10, color: '#888', fontWeight: '700' },
  dateDay: { fontSize: 16, fontWeight: 'bold', color: '#333' },
  expenseInfo: { flex: 1 },
  expenseName: { fontSize: 16, fontWeight: '600', color: '#333', marginBottom: 2 },
  expensePayer: { fontSize: 12, color: 'gray' },
  expenseAmount: { fontSize: 16, fontWeight: 'bold', color: '#333', textAlign: 'right' },
