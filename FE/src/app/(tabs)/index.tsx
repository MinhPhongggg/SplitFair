...
const VerticalFeatureCard = ({ icon, title, description, color, bgColor, onPress }: any) => (
  <TouchableOpacity style={styles.verticalCard} onPress={onPress} activeOpacity={0.8}>
    <View style={[styles.iconContainer, { backgroundColor: bgColor, marginBottom: 12 }]}>
...
const HorizontalFeatureCard = ({ icon, title, description, color, bgColor, onPress }: any) => (
  <TouchableOpacity style={styles.horizontalCard} onPress={onPress} activeOpacity={0.8}>
    <View style={styles.horizontalCardContent}>
        <View style={[styles.iconContainer, { backgroundColor: bgColor, marginRight: 15 }]}>
            <Ionicons name={icon} size={24} color={color} />
        </View>
        <View style={{ flex: 1 }}>
            <Text style={styles.featureTitle}>{title}</Text>
            ...
            <View style={styles.groupList}>
                {recentGroups.map((group, index) => (
                    <TouchableOpacity 
                        ...
                        activeOpacity={0.7}
                    >
                        <View style={[styles.groupIcon, { backgroundColor: index % 2 === 0 ? '#E3F2FD' : '#E8EAF6' }]}>
                            <Text style={[styles.groupInitials, { color: index % 2 === 0 ? '#1565C0' : '#3F51B5' }]}>
                        ...
                        <Ionicons name="chevron-forward" size={18} color="#E0E0E0" style={{ marginLeft: 5 }} />
                    </TouchableOpacity>
                ))}
            </View>
        ) : (
