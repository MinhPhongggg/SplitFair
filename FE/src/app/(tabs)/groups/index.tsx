...
const styles = StyleSheet.create({
  ...
  joinBtn: {
      backgroundColor: APP_COLOR.ORANGE, borderRadius: 12,
  ...
  orText: { marginHorizontal: 10, color: '#999', fontSize: 12, fontWeight: '600' },

  scanBtn: {
      flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
      borderWidth: 1, borderColor: APP_COLOR.ORANGE, borderRadius: 12,
      height: 50, backgroundColor: '#FFF5E5',
  },
  scanBtnText: { color: APP_COLOR.ORANGE, fontSize: 16, fontWeight: '600', marginLeft: 8 },
});
